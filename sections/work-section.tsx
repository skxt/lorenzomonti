...
export const WorkSection = () => {
  return (
    <div className="flex flex-col items-center justify-center mt-30 border-t border-blue-100">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pb-24 p-4 md:p-8 border-b border-blue-100">
          ...
          >
            ...
            <div className="absolute flex items-center justify-between p-3 rounded-lg -bottom-20 group-active:bottom-6 group-hover:bottom-6 left-6 right-6 bg-white transition-all duration-500 ease-in-out">
              ...
              <div className="bg-primary p-2 rounded-full">
                ...
                >
                  <path
                    d="M8.656 1.813 7.273 3.127M2.505 4.51.5 3.957m2.626 3.319L1.813 8.66M3.953.5l.553 2.005M5.23 5.68a.344.344 0 0 1 .452-.452l7.607 3.111a.346.346 0 0 1-.051.657l-3.008.72a.69.69 0 0 0-.511.51l-.72 3.009a.346.346 0 0 1-.657.05z"
                    stroke="#000"
                    strokeLinecap="round"
