  ...
  return (
    <>
      <div className="flex flex-col max-md:px-2 items-center justify-center">
        ...
        <p className="text-center text-base text-zinc-500 max-w-lg mt-4">
          Explore amet minim mollit non deserunt ullamco est sit aliqua dolor do
        ...
        <div className="mt-8 flex items-center justify-center gap-4">
          ...
          <button className="border border-gray-600 text-zinc-500 px-4 py-2.5 rounded-lg hover:bg-gray-900">
            See How It Works
      ...
      <div className="p-3 md:p-6 w-full mt-16 border-t border-blue-100">
        <Image
